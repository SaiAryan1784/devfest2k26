...
// Patched: this project's icons are Phosphor only (see CLAUDE.md). Upstream's
// built-in glyph set ('heart' | 'star' | 'thumb') pulled in a second icon
// family (Hugeicons) purely to draw an SVG the caller could just as easily
// supply. It is removed; `icon` is always the caller's own ReactNode.
