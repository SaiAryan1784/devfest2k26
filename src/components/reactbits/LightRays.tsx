  ...
  useEffect(() => {
    ...
    const initializeWebGL = async () => {
      ...
      const renderer = new Renderer({
        // Patched (kept in sync with docs/SPEC.md): capped at 1 rather than
        // the upstream 2. This is a soft ambient glow behind the hero copy,
        // not a detail surface, so device pixel ratio buys nothing visible
        // but doubles the fragment-shader cost on every high-DPI screen.
...
void main() {
  ...
  gl_FragColor  = color;
      ...
      const updatePlacement = () => {
        ...
        // Patched: capped at 1, see the note where the renderer is created.
