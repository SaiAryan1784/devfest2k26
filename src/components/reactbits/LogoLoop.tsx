// Patched for this project (structure only, no motion logic changed): the
// upstream registry file ships with no directive, but it's all refs/hooks/
// RAF, a client-only leaf. Marking it here keeps it safe to import from a
// Server Component (Partners.tsx) without that caller needing "use client".
"use client";
